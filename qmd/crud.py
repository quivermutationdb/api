...
from qmd.class_properties import TRI as _TRI
from qmd.class_properties import la_bounds as _la_bounds
...
# ---------------------------------------------------------------------------
#
# Mutation-acyclicity resolution (subquiver fallback) lives in
# qmd/class_properties.py, shared with the D1 export path.
